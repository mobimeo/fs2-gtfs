...
function prepareIdxAndDocMap() {
  const docs = [  
    ...
    } ,    
    {
      "title": "Documentation",
      "url": "/documentation/",
      "content": "Welcome to the fs2-gtfs documentation page. You will find here all the information about the library and its modules. Please refer to the menu on the left side."
    } ,          
  ];
